			...
			<!-- Example row of columns -->
				<div class="row">
					<div class="span3 margin_main_container">
						<a href="about-us-boban-ratkovich.php">
							<img src="img/people/Boban.jpg" />
							<h4>Boban Ratkovich</h4>
							<p>PRESIDENT<br/><span style="font-size: 10px;">M. Sc, P. Eng. CEM, BESA, LEED AP ID+C</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
						<a href="about-us-brett-crawford.php">
							...
							<p>ASSOCIATE<br/><span style="font-size: 10px;">P.Eng, LEED AP BD+C</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
						<a href="about-us-slobodan-vukadinov.php">
							<img src="img/people/sloba.jpg" />
							<h4>Slobodan Vukadinov</h4>
							<p>VICE PRESIDENT<br/><span style="font-size: 10px;">M.Sc. in E.E.</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
						<a href="about-us-risto-basic.php">
							<img src="img/people/Risto.jpg" />
							<h4>Risto Basic</h4>
							<p>VICE PRESIDENT<br/><span style="font-size: 10px;">P. Eng, LEED AP BD+C</span></p>
						</a>
					</div>
				</div>
				<div class="row">
					<div class="span3 margin_main_container">
						<a href="about-us-kyle-bigourdin.php">
							...
							<p>ASSOCIATE<br/><span style="font-size: 10px;">P.Eng., CMVP, LEED AP BD+C</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
						<a href="about-us-homayoun-khatami.php">
							...
							<p>ASSOCIATE<br/><span style="font-size: 10px;">P.Eng., CEM, PMP, CMVP, CMC, LEED AP</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
					...
					<div class="span3 margin_main_container">
						<a href="about-us-steven-quan.php">
							...
							<h4>Steven Quan</h4>
							<p>ENGINEERING ASSISTANT<br/><span style="font-size: 10px;">BASc, E.I.T.</span></p>
						</a>
					</div>
				</div>
				<div class="row">
					...
					<div class="span3 margin_main_container">
						<a href="about-us-johnson-shen.php">
							...
							<h4>Johnson Shen</h4>
							<p>ENERGY MODELLER<br/><span style="font-size: 10px;">BASc, EIT</span></p>
						</a>
					</div>
					<div class="span3 margin_main_container">
						<a href="about-us-daniel-alfonso-ponte.php">
							...
							<p>ENGINEER<br/><span style="font-size: 10px;">B.Sc. Mech . Eng.</span></p>
						</a>
					</div>
				</div>
				<div class="row">
